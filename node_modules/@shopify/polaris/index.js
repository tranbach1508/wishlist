...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '4.8.0';
}

var polarisVersion = '4.8.0';
...
function hexToHsluvObj(hex) {
  var _hexToHsluv = hsluv.hexToHsluv(hex),
...
function buildColors(theme) {
  ...
  var allColors = Object.entries(colorAdjustments).reduce(function (accumulator, _ref) {
    ...
    var baseColor = hexToHsluvObj(colors[colorAdjustment.baseColor]);
    var _colorAdjustment = colorAdjustment[lightSurface ? 'light' : 'dark'],
        ...
        alpha = _colorAdjustment$alph === void 0 ? 1 : _colorAdjustment$alph;
    return Object.assign({}, accumulator, {
      [colorRole]: hslToString(Object.assign({}, colorToHsla(hsluv.hsluvToHex([hue, saturation, lightness])), {
        alpha
      }))
    });
  }, {});
...
function useForcibleToggle(initialState) {
  ...
  var toggles = {
    ...
    forceTrue: React.useCallback(function () {
      return setState(true);
    }, []),
    forceFalse: React.useCallback(function () {
...
function ButtonGroup(_ref) {
  ...
  var className = classNames(styles$5.ButtonGroup, segmented && styles$5.segmented, fullWidth && styles$5.fullWidth, connectedTop && styles$5.connectedTop);
  ...
  _createClass(Scrollable, [{
    ...
    value: function render() {
      ...
      var _a = this.props,
          ...
          rest = tslib_1.__rest(_a, ["children", "className", "horizontal", "vertical", "shadow", "hint", "onScrolledToBottom"]);
...
var Popover = function Popover(_a) {
  ...
  var setAccessibilityAttributes = React.useCallback(function () {
    ...
    var firstFocusable = focus.findFirstFocusableNode(activatorContainer.current);
  ...
  var handleClose = function handleClose(source) {
    ...
    if ((source === exports.PopoverCloseSource.FocusOut || source === exports.PopoverCloseSource.EscapeKeypress) && activatorNode) {
      var focusableActivator = focus.findFirstFocusableNode(activatorNode) || focus.findFirstFocusableNode(activatorContainer.current) || activatorContainer.current;
...
var getUniqueId = other.createUniqueIDFactory('ComboBox');
var ComboBox =
/*#__PURE__*/
function (_React$PureComponent) {
...
function TextField(_ref) {
  ...
  var resizer = multiline && isMounted ? React__default.createElement(Resizer, {
...
var getUniqueID$1 = other.createUniqueIDFactory('DropZone');
...
function (_React$Component) {
  ...
  function DropZone(props) {
    ...
    _this.handleDragEnter = function (event) {
      ...
      if (event.target && !_this.dragTargets.includes(event.target)) {
    ...
    _this.state = {
      id: props.id || getUniqueID$1(),
      dragging: false,
      error: false,
      errorOverlayText: intl.translate("Polaris.DropZone.errorOverlayText".concat(suffix)),
      focused: false,
      numFiles: 0,
      overlayText: intl.translate("Polaris.DropZone.overlayText".concat(suffix)),
      size: 'extraLarge',
      type
    };
    return _this;
...
function FadeUp(_a) {
  ...
  return React__default.createElement(reactTransitionGroup.CSSTransition, Object.assign({}, props, {
...
var getUniqueID$2 = other.createUniqueIDFactory('modal-header');
...
function Item$7(_ref) {
  ...
  var itemContentMarkup = React__default.createElement(React.Fragment, null, iconMarkup, React__default.createElement("span", {
    ...
    value: function render() {
      ...
      var itemsMarkup = items.map(function (item) {
        var onClick = item.onClick,
            ...
            rest = tslib_1.__rest(item, ["onClick", "label", "subNavigationItems"]);
...
var getUniqueID$3 = other.createUniqueIDFactory('TooltipContent');
var Tooltip =
/*#__PURE__*/
function (_React$PureComponent) {
...
function Title(_ref) {
  ...
  var titleMarkup = title ? React.createElement("div", {
    className: styles$1g.Title
  }, React.createElement(DisplayText, {
    size: "large",
    element: "h1"
  }, title)) : null;
  var titleMetadataMarkup = titleMetadata ? React.createElement("div", {
    className: styles$1g.TitleMetadata
  }, titleMetadata) : null;
  var wrappedTitleMarkup = titleMetadata ? React.createElement("div", {
    className: styles$1g.TitleWithMetadataWrapper
  }, titleMarkup, titleMetadataMarkup) : titleMarkup;
  var subtitleMarkup = subtitle ? React.createElement("div", {
    className: styles$1g.SubTitle
  }, React.createElement("p", null, subtitle)) : null;
  var thumbnailMarkup = thumbnail ? React.createElement("div", null, thumbnail) : null;
  var pageTitleClassName = thumbnail ? classNames(styles$1g.hasThumbnail) : undefined;
  return React.createElement("div", {
    className: pageTitleClassName
  }, thumbnailMarkup, React.createElement("div", {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      var _a = this.props,
          ...
          rest = tslib_1.__rest(_a, ["children", "fullWidth", "narrowWidth", "singleColumn"]);
...
function RangeSlider(_a) {
  var _a$min = _a.min,
      ...
      value = _a.value,
      rest = tslib_1.__rest(_a, ["min", "max", "step", "value"]);
  ...
  _createClass(BaseResourceItem, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      var _a = nextProps.context,
          ...
          restNextContext = tslib_1.__rest(_a, ["selectedItems"]),
          restNextProps = tslib_1.__rest(nextProps, ["context"]);

      var _b = this.props,
          _c = _b.context,
          selectedItems = _c.selectedItems,
          restContext = tslib_1.__rest(_c, ["selectedItems"]),
          restProps = tslib_1.__rest(_b, ["context"]);
...
function (_React$PureComponent) {
  ...
  function BulkActionButton() {
    ...
    _this.bulkActionButton = React.createRef();
    return _this;
  }
...
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var smallScreenGroup = smallScreen ? React__default.createElement(reactTransitionGroup.Transition, {
        timeout: 0,
        in: selectMode,
        key: "smallGroup",
      ...
      var largeScreenGroup = smallScreen ? null : React__default.createElement(reactTransitionGroup.Transition, {
        timeout: 0,
        in: selectMode,
        key: "largeGroup",
  ...
  _createClass(ResourcePicker, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var prevAppBridge = prevProps.polaris.appBridge,
          prevResourcePickerProps = tslib_1.__rest(prevProps, ["polaris"]);

      var _a = this.props,
          appBridge = _a.polaris.appBridge,
          resourcePickerProps = tslib_1.__rest(_a, ["polaris"]);
...
function Tab(_ref) {
  ...
  var node = React.useRef(null); // A tab can start selected when it is moved from the disclosure dropdown
