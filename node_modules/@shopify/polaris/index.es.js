import React__default, { useContext, useState, useEffect, useCallback, useRef, createRef, useMemo, useLayoutEffect, useImperativeHandle, createContext, memo, Fragment, createElement } from 'react';
...
function buildColors(theme) {
  ...
  var allColors = Object.entries(colorAdjustments).reduce(function (accumulator, _ref) {
    ...
    return Object.assign({}, accumulator, {
      [colorRole]: hslToString(Object.assign({}, colorToHsla(hsluvToHex([hue, saturation, lightness])), {
        alpha
      }))
    });
  }, {});
...
var getUniqueID$1 = createUniqueIDFactory('DropZone');
...
var getUniqueID$2 = createUniqueIDFactory('modal-header');
...
var getUniqueID$3 = createUniqueIDFactory('TooltipContent');
var Tooltip =
/*#__PURE__*/
function (_React$PureComponent) {
