...
class Filters extends React.Component {
    ...
    render() {
        const { filters, queryValue, onQueryBlur, onQueryChange, onQueryFocus, focused, onClearAll, appliedFilters, polaris: { intl, mediaQuery: { isNavigationCollapsed }, }, onQueryClear, queryPlaceholder, children, disabled = false, helpText, } = this.props;
        ...
        const filtersContentMarkup = filters.map((filter, index) => {
          ...
          <button onClick={() => this.toggleFilter(filter.key)} className={styles.FilterTrigger} id={`${filter.key}ToggleButton`} type="button" aria-controls={collapsibleID} aria-expanded={filterIsOpen}>
        ...
        const filtersDesktopHeaderMarkup = (<div className={styles.FiltersContainerHeader}>
        ...
        const filtersMobileHeaderMarkup = (<div className={styles.FiltersContainerHeader}>
        <Button icon={CancelSmallMinor} plain accessibilityLabel={intl.translate('Polaris.Filters.cancel')} onClick={this.closeFilters}/>
        <DisplayText size="small">
          {intl.translate('Polaris.Filters.moreFilters')}
        </DisplayText>
        ...
        const filtersDesktopFooterMarkup = (<div className={styles.FiltersContainerFooter}>
        ...
        const tagsMarkup = appliedFilters && appliedFilters.length ? (<div className={styles.TagsContainer}>
