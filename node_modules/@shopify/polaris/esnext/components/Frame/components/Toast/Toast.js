...
export function Toast({ content, onDismiss, duration, error, action, }) {
    useEffect(() => {
    ...
    const dismissMarkup = (<button type="button" className={styles.CloseButton} onClick={onDismiss} testID="closeButton">
      <Icon source={MobileCancelMajorMonotone}/>
    </button>);
    const actionMarkup = action ? (<div className={styles.Action}>
