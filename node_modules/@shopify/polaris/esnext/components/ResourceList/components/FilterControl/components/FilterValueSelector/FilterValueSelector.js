...
export function FilterValueSelector({ filter, filterKey, value, onChange, onFilterKeyChange, }) {
    ...
    switch (filter.type) {
        case FilterType.Select:
          ...
          <Select label={selectedFilterLabel} options={filter.options} placeholder={translate('Polaris.ResourceList.FilterValueSelector.selectFilterValuePlaceholder')} value={value} onChange={onChange}/>
        </Stack>);
