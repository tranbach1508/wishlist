...
class DropZone extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            dragging: false,
            error: false,
            errorOverlayText: intl.translate(`Polaris.DropZone.errorOverlayText${suffix}`),
            focused: false,
            numFiles: 0,
    ...
    render() {
        const { id, dragging, focused, error, size, type, overlayText, errorOverlayText, } = this.state;
        const { label, labelAction, labelHidden, children, disabled = false, outline, accept, active, overlay, allowMultiple, polaris: { intl }, } = this.props;
        ...
        const classes = classNames(styles.DropZone, outline && styles.hasOutline, focused && styles.focused, (active || dragging) && styles.isDragging, disabled && styles.isDisabled, error && styles.hasError, size && size === 'extraLarge' && styles.sizeExtraLarge, size && size === 'large' && styles.sizeLarge, size && size === 'medium' && styles.sizeMedium, size && size === 'small' && styles.sizeSmall);
