...
export function buildColors(theme) {
    ...
    const allColors = Object.entries(colorAdjustments).reduce((accumulator, [colorRole, colorAdjustment]) => {
        ...
        const { hue = baseColor.hue, saturation = baseColor.saturation, lightness = baseColor.lightness, alpha = 1, } = colorAdjustment[lightSurface ? 'light' : 'dark'];
        return Object.assign({}, accumulator, { [colorRole]: hslToString(Object.assign({}, colorToHsla(hsluvToHex([hue, saturation, lightness])), { alpha })) });
    }, {});
